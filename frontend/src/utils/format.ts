...
export const EXCLUSION_LABEL: Record<string, string> = {
  ...
  FARE_VARIANT: 'Более дорогой тариф того же рейса',
...
export const FILTER_REASON_LABEL: Record<string, string> = {
  ...
  CABIN_CLASS_MISMATCH: 'Не эконом-класс',
  REFUNDABLE_FARE: 'Возвратный тариф',
  NOT_DIRECT: 'Рейс с пересадкой',
  RAIL_SERVICE_CLASS_UNKNOWN: 'Класс обслуживания не сообщен',
  RAIL_SERVICE_CLASS_MISMATCH: 'Не та категория вагона',
